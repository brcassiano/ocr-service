...
print("=" * 80)
print(">>> OCR_ENGINE.PY CARREGADO (VERSÃO FINAL: MATEMÁTICA + FIX INIT) <<<")
print("=" * 80)
...
class OCREngine:
    ...
    def __init__(self, use_gpu: bool = False):
        try:
            # Ajuste para compatibilidade de versões do PaddleOCR
            params = {
                "use_angle_cls": False,
                "lang": "pt",
                "show_log": False
            }
            # Adiciona use_gpu apenas se explicitamente True, 
            # pois algumas versões crasham se passar use_gpu=False
            if use_gpu:
                params["use_gpu"] = True
            ...
            # Fallback se os argumentos mudaram
            try:
